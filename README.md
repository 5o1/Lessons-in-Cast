...
| Incorrect `!` and `?` pause handling | Fix the bug that prevents the model or adapter from interpreting pauses and boundaries around exclamation and question marks correctly. | Open bug |
