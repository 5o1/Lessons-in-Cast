"""Yasu voice rendering through the IndexTTS 2.5 backend."""
...
class YasuIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Yasu."""

    @property
    def pipeline_id(self) -> str:
        return "yasu-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return YasuIndexTtsPipeline(context)
