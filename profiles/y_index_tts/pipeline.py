"""Yumi voice rendering through the IndexTTS 2.5 backend."""
...
class YumiIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Yumi."""

    @property
    def pipeline_id(self) -> str:
        return "yumi-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return YumiIndexTtsPipeline(context)
