"""Sara voice rendering through the IndexTTS 2.5 backend."""
...
class SaraIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Sara."""

    @property
    def pipeline_id(self) -> str:
        return "sara-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return SaraIndexTtsPipeline(context)
