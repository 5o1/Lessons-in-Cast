"""Haruka voice rendering through the IndexTTS 2.5 backend."""
...
class HarukaIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Haruka."""

    @property
    def pipeline_id(self) -> str:
        return "haruka-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return HarukaIndexTtsPipeline(context)
