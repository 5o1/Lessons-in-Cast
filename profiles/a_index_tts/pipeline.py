"""Ami voice rendering through the IndexTTS 2.5 backend."""
...
class AmiIndexTtsPipeline(IndexTtsPipeline):
    """The active IndexTTS voice pipeline for Ami."""

    @property
    def pipeline_id(self) -> str:
        return "ami-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return AmiIndexTtsPipeline(context)
