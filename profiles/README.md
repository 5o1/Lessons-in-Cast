...
profile. Per-dialogue profile overrides are intentionally not implemented yet.

The current bundle uses this inheritance structure:
...
Its `config.toml` owns the IndexTTS model ID, `base_speed`, inference
