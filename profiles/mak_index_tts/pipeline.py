"""Makoto voice rendering through the IndexTTS 2.5 backend."""
...
class MakotoIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Makoto."""

    @property
    def pipeline_id(self) -> str:
        return "makoto-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return MakotoIndexTtsPipeline(context)
