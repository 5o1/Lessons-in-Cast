"""Kirin voice rendering through the IndexTTS 2.5 backend."""
...
class KirinIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Kirin."""

    @property
    def pipeline_id(self) -> str:
        return "kirin-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return KirinIndexTtsPipeline(context)
