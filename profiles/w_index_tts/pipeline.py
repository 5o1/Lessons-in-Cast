"""Wakana voice rendering through the IndexTTS 2.5 backend."""
...
class WakanaIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Wakana."""

    @property
    def pipeline_id(self) -> str:
        return "wakana-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return WakanaIndexTtsPipeline(context)
