"""Sana voice rendering through the IndexTTS 2.5 backend."""
...
class SanaIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Sana."""

    @property
    def pipeline_id(self) -> str:
        return "sana-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return SanaIndexTtsPipeline(context)
