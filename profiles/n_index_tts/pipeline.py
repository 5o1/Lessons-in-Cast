"""Noriko voice rendering through the IndexTTS 2.5 backend."""
...
class NorikoIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Noriko."""

    @property
    def pipeline_id(self) -> str:
        return "noriko-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return NorikoIndexTtsPipeline(context)
