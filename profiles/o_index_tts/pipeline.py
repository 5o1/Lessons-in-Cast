"""Otoha voice rendering through the IndexTTS 2.5 backend."""
...
class OtohaIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Otoha."""

    @property
    def pipeline_id(self) -> str:
        return "otoha-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return OtohaIndexTtsPipeline(context)
