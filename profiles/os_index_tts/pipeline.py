"""Osako voice rendering through the IndexTTS 2.5 backend."""
...
class OsakoIndexTtsPipeline(IndexTtsPipeline):
    """The initial IndexTTS voice pipeline for Osako."""

    @property
    def pipeline_id(self) -> str:
        return "osako-index-tts-2.5"
...
def create_pipeline(context: VoiceProfileContext) -> VoicePipeline:
    ...
    return OsakoIndexTtsPipeline(context)
